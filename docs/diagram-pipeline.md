...
- **N** = number of windows = (trading days − 60 warmup − window − 1 + 1), where 60 is the SMA-60 lookback, 1 is for the target computation, and +1 accounts for the inclusive sliding window count
